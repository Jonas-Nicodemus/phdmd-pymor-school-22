...
\begin{tikzpicture}
    ...
    \tikzstyle{damper}=[line width=1pt,decoration={markings,  
      ...
      {
        \node (dmp) [line width=1pt,inner sep=0pt,transform shape,rotate=-90,minimum
    width=0.25*\massHeight,minimum height=0.125*\massWidth,draw=none] {};
        \draw [line width=1pt] ($(dmp.north east)+(2pt,0)$) -- (dmp.south east) -- (dmp.south
    west) -- ($(dmp.north west)+(2pt,0)$);
        \draw [line width=1pt] ($(dmp.north)+(0,-0.08*\massHeight)$) -- ($(dmp.north)+(0,0.08*\massHeight)$);
      }
    }, decorate]
